export type PumpFun = {
  ...
  instructions: [
    ...
    {
      name: "migrate";
      docs: ["Migrates liquidity to pump_amm if bonding curve is complete"];
      ...
      accounts: [
        ...
        {
          name: "creator";
          docs: ["metadata account creators only if creators is not None"];
          writable: true;
        },
        {
          name: "pump_amm";
  ...
  errors: [
    ...
    {
      code: 6011;
      name: "initial_real_token_reservesShouldBeLessThantoken_total_supply";
      msg: "initial_real_token_reserves should be less than token_total_supply";
    },
    {
      code: 6012;
      name: "initial_virtual_token_reservesShouldBeGreaterThaninitial_real_token_reserves";
      msg: "initial_virtual_token_reserves should be greater than initial_real_token_reserves";
    },
    {
      code: 6013;
      name: "fee_basis_pointsGreaterThanMaximum";
    ...
    {
      code: 6015;
      name: "PoolMigrationFeeShouldBeLessThanFinalreal_sol_reserves";
    ...
    {
      code: 6028;
      name: "Allfee_recipientsShouldBeNonZero";
      msg: "All fee recipients should be non-zero";
    },
    {
      code: 6029;
      name: "UnsortedNotUniquefee_recipients";
